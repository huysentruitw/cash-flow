...
namespace CashFlow.Command.Abstractions
{
    ...
    /// Activate a code
    /// </summary>
    public sealed class ActivateCodeCommand : Command
    {
        /// <summary>
        /// The name of the code to activate
        /// </summary>
        public string Name { get; set; }
    }
    ...
    /// Deactivate a code
    /// </summary>
    public sealed class DeactivateCodeCommand : Command
    {
        /// <summary>
        /// The name of the code to deactivate
        /// </summary>
        public string Name { get; set; }
    }
